...
with open("/Users/chrisfaris/Desktop/python/Seminar Project/2024_data.txt", "r") as file:
...
plt.title(' Closing Stock Prices for AAPL, MSFT, GOOGL, and AMZN (Sep 2024 - Oct 2024)')
...
plt.savefig('2024_graph.png', bbox_inches='tight')
...
for ticker, color in tickers.items():
    ...
    plt.title(f'Stock Prices for {ticker} (Sep 2024 - Oct 2024)')

    # Rotate x-axis labels for better readability
    plt.xticks(rotation=45)

    # Save the plot to a file
    plt.savefig(f'2024_{ticker}.png', bbox_inches='tight')
